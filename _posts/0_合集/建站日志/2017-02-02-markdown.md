...
| 公司  | 公式                                     | 数值    |
|-------|------------------------------------------|---------|
| 公司A<td rowspan="2">公司b</td> | $Y_i = \alpha + \beta X_i + \varepsilon_i$ | 公式值1 |
|       | $E(\varepsilon_i\mid X_i) = 0$           | 公式值2 |
| 公司B | $var(\varepsilon_i\mid X_i) = \sigma^2$   | 公式值3 |
|       | $cov(\varepsilon_i,\varepsilon_j) = 0$   | 公式值4 |
