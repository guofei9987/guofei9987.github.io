...
B+树可用于：
1. 主键、稠密索引 ![Btree](/a/computer/database/file_b+1.svg)
2. 主键、稀疏索引 ![Btree](/a/computer/database/file_b+2.svg)
3. B+树用于非主键、稠密索引，索引不重复 ![Btree](/a/computer/database/file_b+3.svg)
4. B+树用于非主键、稠密索引，索引重复 ![Btree](/a/computer/database/file_b+4.svg)
