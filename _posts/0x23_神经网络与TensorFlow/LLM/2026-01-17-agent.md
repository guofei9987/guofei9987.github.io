...
api_key = "xxx" # 同上的密钥管理
base_url="https://xxx.xxx.com/v1/chat/completions" # 注意结尾是 /v1/chat/completions
model_name = 'GLM-5.2'
...
payload["response_format"] = {
    ...
    "json_schema": {
        ...
        "schema": {
            "type": "object",
            "properties": {
                "概念名": {"type": "string", "description": "需要解释的概念名称"},
                "解释": {"type": "string", "description": "简明解释，不超过15字"},
                "归类": {"type": "string", "description": "该概念所属的知识领域"},
                "难度": {"type": "string", "enum": ["入门", "基础", "中等", "进阶"], "description": "学习该概念的难度"}
            },
            "required": ["概念名", "解释", "归类", "难度"],
...
# 注意
# 1. description 也会起作用（大部分模型），与提示词的作用差不多
# 2. 不一定对所有模型都兼容，使用前注意测试
```
