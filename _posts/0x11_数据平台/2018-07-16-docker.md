...
3. Repository：存储、分发 Image 的服务（https://hub.docker.com/, ghcr.io）。一个 Docker Registry  中包含多个 Repository，每个 Repository 包含多个 Tag ，每个 Tag 包含一个镜像。  
...
Docker Desktop 有时候不好用，可以用 colima
...
docker hub 网络问题比较多，可以用 github：

```shell
# 登陆，输入 token（不是密码）
docker login ghcr.io -u guofei9987

# 上传
# step1:打 docker
docker tag my-jekyll ghcr.io/guofei9987/my-jekyll:latest
# step2:push
docker push ghcr.io/guofei9987/my-jekyll:latest

# 拉取
docker pull ghcr.io/guofei9987/my-jekyll:latest
```
