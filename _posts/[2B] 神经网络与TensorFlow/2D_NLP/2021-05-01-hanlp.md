...
//      要点5:  加载已保存的模型
        LinearModel model1 = new LinearModel(MODEL_PATH);
        Segment segment1 = new PerceptronLexicalAnalyzer(model1).enableCustomDictionary(false);
        System.out.println(segment1.seg("商品和服务"));
    }
}
```
